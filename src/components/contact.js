    ...
    >
      <div className="contact-max-width thq-section-max-width">
        <div className="contact-section-title">
          <span className="contact-text thq-body-small">{props.content2}</span>
...
Contact.defaultProps = {
  ...
  content4: 'We look forward to connecting with you.',
  content5: 'Follow us on social media for updates and news.',
  content3:
    'Feel free to contact us via email or phone, or visit our office during working hours.',
  content2: 'Our team is available to assist you during our business hours.',
  address1: 'The Gala Tower, No°7, Salé, KOM',
  phone1: '+44 7535 998963\n',
  heading1: 'Get in Touch',
  email1: 'office@d11.group\n',
  rootClassName: '',
}
