          ...
          <div className="footer-links">
            ...
            <div className="footer-column3">
              ...
              <div className="footer-social-links">
                <a
                  href="https://www.facebook.com/d11group/"
                  target="_blank"
                  rel="noreferrer noopener"
                ...
                <a
                  href="https://www.instagram.com/d11group"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="thq-body-small footer-link2"
                >
                ...
                <a
                  href="https://x.com/d11_group"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="thq-body-small footer-link4"
                >
                ...
                <a
                  href="https://www.linkedin.com/company/d11-group/"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="thq-body-small footer-link6"
                >
...
Footer.defaultProps = {
  content3: '2024 D11 Group. All Rights Reserved.',
